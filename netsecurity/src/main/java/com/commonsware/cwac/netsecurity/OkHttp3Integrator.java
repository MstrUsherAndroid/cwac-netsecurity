...
public class OkHttp3Integrator {
  ...
  public static OkHttpClient.Builder applyTo(  TrustManagerBuilder tmb, OkHttpClient.Builder builder) throws NoSuchAlgorithmException, KeyManagementException {
